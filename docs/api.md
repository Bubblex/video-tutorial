...
| message | String | 1: 登录成功 | 0: 登录失败 200: 账号或密码错误 201: 账户已禁用 202: 账户已删除 203: 账户不存在 | 返回信息 |
| data    | Object | 返回数据    | null                                     | 返回数据 |
...
| message | String | 1: 查询数据成功 | 0: 查询失败     | 返回信息 |
| data    | Object | 返回数据      | null        | 返回数据 |
...
| 名称   | 类型     | 必填   | 可选值  | 说明                     |
| :--- | :----- | :--- | :--- | :--------------------- |
| id   | Number | 否    | -    | 用户 id，如果填写 token 则该项可选 |
