...
| 名称      | 类型     | 成功      | 失败                                       | 说明   |
| :------ | :----- | :------ | :--------------------------------------- | :--- |
| code    | Number | 1       | 0, 200, 201, 202                         | 状态码  |
| message | String | 1: 登录成功 | 0: 登录失败 200: 账号或密码错误 201: 账户已禁用 202: 账户已删除 | 返回信息 |
| data    | Object | 返回数据    | null                                     | 返回数据 |
...
| :------ | :----- | :------ | :------ | :--- |
| code    | Number | 1       | 0       | 状态码  |
| message | String | 1: 注册成功 | 0: 注册失败 | 返回信息 |
...
| message | String | 1: 修改成功 | 0: 修改失败 200: 账号或密码错误 | 返回信息 |
| data    | Object | null    | null                 | 返回数据 |
